...
test:
	...
	if (! (grep "FAIL" tests/results.log >/dev/null)) ; then echo "\e[1m\e[32mCongrats! ALL TESTS PASSED.\e[0m" ; else echo "\e[1m\e[31mSorry! SOME TEST HAS FAILED.\e[0m" ; exit 1 ; fi
