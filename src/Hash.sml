...
fun hash_of_TESL_atomic (f: TESL_atomic): int = case f of
  ...
  | TimeDelayedBy (c1, t, c2, c3, c4)	              => 61	* (hash_of_clock c1)
								   ...
								   * (hash_of_clock c4)
  | WhenTickingOn (c1, t, c2)	                     => 67	* (hash_of_clock c1) * (hash_of_tag t) * (hash_of_clock c2)
  | WhenTickingOnWithReset (c1, t, c2, c3) 		=> 71	* (hash_of_clock c1) * (hash_of_tag t) * (hash_of_clock c2) * (hash_of_clock c3)
