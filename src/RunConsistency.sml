...
(*
    (* - Two timestamps [H ⇓_σ C] and [X^σ_H = α * _ + β], where [X^σ_H] is a variable [C] is a constant *)
    ...
    (* - Two timestamps [H ⇓_σ C] and [_ = α * X^σ_H + β], where [X^σ_H] is a variable [C] is a constant *)
